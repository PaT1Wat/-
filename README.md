...
**ขั้นตอน:**
1. ดาวน์โหลด Python installer
2. รัน installer และ **✅ เลือก "Add Python to PATH"**
3. กด Install Now
...
```
**วิธีแก้:** ติดตั้งใหม่และเลือก "Add Python to PATH" หรือเพิ่ม Python ใน System Environment Variables

---

### 2. Node.js 18+ และ npm

**ดาวน์โหลด:** https://nodejs.org/ (เลือก LTS version)

**ขั้นตอน:**
1. ดาวน์โหลด Node.js installer
2. รัน installer (npm จะติดตั้งมาด้วยอัตโนมัติ)
3. Restart terminal หลังติดตั้ง
...
```
**วิธีแก้:** Restart terminal หรือติดตั้ง Node.js ใหม่
...
| npm | 9+ | (มากับ Node.js) |
| Git | ล่าสุด | https://git-scm.com/downloads |
